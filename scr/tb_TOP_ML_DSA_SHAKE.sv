...
module tb_TOP_ML_DSA_SHAKE();
    ...
    task send_word;
        ...
        begin
            if (!mute_log)
                $display("Data: %016X | Last: %b | 16bit_Suffix: %b", t_data, t_is_last, t_is_16bit);
    ...
    initial begin
        ...
        check_hash(1088'); /* <-- DÁN KẾT QUẢ PYTHON VÀO ĐÂY */
    ...
    initial begin
        $dumpfile("wave_top_ml_dsa_shake.vcd");
        $dumpvars(0, tb_TOP_ML_DSA_SHAKE);
    end
